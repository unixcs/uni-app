...
## 本文件是v2.1.0版本的数据库修改记录，通过查看后端根目录下的version.json文件确定当前系统版本号
## 说明：如果你当前的版本号小于v2.1.0，那么在升级时需要执行本文件的sql内容
## 当前文件执行内容较多，为避免造成损失，请务必先备份数据库 请务必先备份数据库 请务必先备份数据库
...
CREATE TABLE `yoshop_store_menu` (
  ...
  `path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '菜单路径(唯一)',
  `is_page` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '是否为页面(1是 0否)',
  `module_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '功能模块key',
  `action_mark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '操作标识',
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10269 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商家后台菜单记录表';
...
CREATE TABLE `yoshop_store_api` (
  ...
  `url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '权限url',
  `parent_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '父级ID',
  `sort` int(11) unsigned NOT NULL DEFAULT '100' COMMENT '排序(数字越小越靠前)',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`api_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11338 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商家后台api权限表';
...
INSERT INTO `yoshop_store_api` VALUES ('11316', '上传视频文件', '/upload/video', '11008', '112', '1614556800', '1614556800');
...
CREATE TABLE `yoshop_store_menu_api` (
  ...
  PRIMARY KEY (`id`),
  KEY `menu_id` (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11347 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商家后台菜单与API权限关系表';
...
INSERT INTO `yoshop_store_menu_api` VALUES ('11001', '10055', '11078', '1614556800');
INSERT INTO `yoshop_store_menu_api` VALUES ('11002', '10055', '11165', '1614556800');
INSERT INTO `yoshop_store_menu_api` VALUES ('11003', '10055', '11169', '1614556800');
INSERT INTO `yoshop_store_menu_api` VALUES ('11004', '10055', '11180', '1614556800');
INSERT INTO `yoshop_store_menu_api` VALUES ('11005', '10055', '11171', '1614556800');
INSERT INTO `yoshop_store_menu_api` VALUES ('11008', '10055', '11132', '1614556800');
INSERT INTO `yoshop_store_menu_api` VALUES ('11009', '10055', '11076', '1614556800');
INSERT INTO `yoshop_store_menu_api` VALUES ('11010', '10055', '11164', '1614556800');
INSERT INTO `yoshop_store_menu_api` VALUES ('11011', '10055', '11154', '1614556800');
INSERT INTO `yoshop_store_menu_api` VALUES ('11012', '10055', '11170', '1614556800');
INSERT INTO `yoshop_store_menu_api` VALUES ('11014', '10055', '11020', '1614556800');
...
INSERT INTO `yoshop_store_menu_api` VALUES ('11220', '10236', '11134', '1614556800');
INSERT INTO `yoshop_store_menu_api` VALUES ('11221', '10236', '11133', '1614556800');
...
CREATE TABLE `yoshop_payment` (
  ...
  `client` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '客户端(H5、小程序、APP)',
  `method` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '支付方式(微信、支付宝、余额)',
  ...
  `others` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '其他选项(json格式)',
...
CREATE TABLE `yoshop_payment_template` (
  ...
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '支付模板名称',
  `method` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '支付方式(微信、支付宝、余额)',
  `config` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '支付配置(json格式)',
  `remarks` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '管理员备注',
  `wechatpay_serial` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '微信支付V3平台证书序号',
...
CREATE TABLE `yoshop_payment_trade` (
  ...
  `out_trade_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '交易订单号(全局唯一)',
  `client` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '发起客户端(H5、小程序、APP)',
  `pay_method` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '支付方式(微信、支付宝)',
  ...
  `order_no` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商城订单号(商城订单、充值订单)',
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '下单用户ID',
  `trade_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '第三方交易流水号',
  `prepay_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '预支付交易会话ID(微信支付)',
...
CREATE TABLE `yoshop_printer` (
  ...
  `printer_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '打印机名称',
  `printer_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '打印机类型',
  `printer_config` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '打印机配置',
  `print_times` smallint unsigned NOT NULL DEFAULT '0' COMMENT '打印联数(次数)',
  `sort` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '排序 (数字越小越靠前)',
  `is_delete` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '是否删除',
  `store_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '商城ID',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  ...
  KEY `store_id` (`store_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10001 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='小票打印机记录表';
...
CREATE TABLE `yoshop_order_delivery` (
  ...
  `pack_method` tinyint(3) unsigned NOT NULL DEFAULT '10' COMMENT '打包方式(废弃)',
  `express_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '物流公司ID',
  `express_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '物流单号',
  `eorder_html` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '电子面单模板内容',
  `store_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '商城ID',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
...
ADD COLUMN `order_type` tinyint(3) UNSIGNED NOT NULL DEFAULT 10 COMMENT '订单类型(10实物订单)' AFTER `order_no`;

ALTER TABLE `yoshop_order`
ADD COLUMN `pay_method` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '支付方式(余额/微信/支付宝)' AFTER `buyer_remark`;

ALTER TABLE `yoshop_goods`
ADD COLUMN `goods_type` tinyint(3) unsigned NOT NULL DEFAULT '10' COMMENT '商品类型(10实物商品)' AFTER `goods_id`;

DROP TABLE IF EXISTS `yoshop_system_process`;
CREATE TABLE `yoshop_system_process` (
  `key` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '进程标识',
...
ALTER TABLE `yoshop_admin_user` MODIFY COLUMN `user_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '用户名' AFTER `admin_user_id`;

ALTER TABLE `yoshop_admin_user` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_article` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_article_category` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_cart` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_category` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_comment` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_coupon` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_delivery` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_express` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_goods` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_goods_category_rel` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_goods_image` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_goods_service` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_goods_service_rel` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_goods_sku` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_goods_spec_rel` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_h5_setting` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_help` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_order` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_order_export` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_order_goods` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_order_refund` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_order_refund_address` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_order_refund_image` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_page` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_recharge_order` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_recharge_order_plan` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_recharge_plan` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_region` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_spec` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_spec_value` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_store` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_store_address` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_store_role` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_store_role_menu` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_store_setting` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_store_user` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_store_user_role` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_upload_file` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_upload_group` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_user` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_user_address` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_user_balance_log` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_user_coupon` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_user_grade` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_user_grade_log` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_user_oauth` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_user_points_log` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_wxapp_setting` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_delivery_rule` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_order_address` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `yoshop_comment_image` DEFAULT CHARACTER SET=utf8mb4 COLLATE=utf8mb4_unicode_ci;


# 2

ALTER TABLE `yoshop_admin_user` MODIFY COLUMN `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '登录密码' AFTER `user_name`;

ALTER TABLE `yoshop_article` MODIFY COLUMN `title` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '文章标题' AFTER `article_id`;

ALTER TABLE `yoshop_article` MODIFY COLUMN `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '文章内容' AFTER `image_id`;

ALTER TABLE `yoshop_article_category` MODIFY COLUMN `category_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '文章分类ID' FIRST ;

ALTER TABLE `yoshop_article_category` MODIFY COLUMN `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '分类名称' AFTER `category_id`;

ALTER TABLE `yoshop_article_category` MODIFY COLUMN `status` tinyint(3) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态(1显示 0隐藏)' AFTER `name`;

ALTER TABLE `yoshop_cart` MODIFY COLUMN `goods_sku_id` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '商品sku唯一标识' AFTER `goods_id`;

ALTER TABLE `yoshop_category` MODIFY COLUMN `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '分类名称' AFTER `category_id`;

ALTER TABLE `yoshop_comment` MODIFY COLUMN `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '评价内容' AFTER `score`;

ALTER TABLE `yoshop_coupon` MODIFY COLUMN `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '优惠券名称' AFTER `coupon_id`;

ALTER TABLE `yoshop_coupon` MODIFY COLUMN `apply_range_config` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '适用范围配置(json格式)' AFTER `apply_range`;

ALTER TABLE `yoshop_coupon` MODIFY COLUMN `describe` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '优惠券描述' AFTER `receive_num`;

ALTER TABLE `yoshop_delivery` MODIFY COLUMN `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '模板名称' AFTER `delivery_id`;

ALTER TABLE `yoshop_delivery_rule` MODIFY COLUMN `region` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '可配送区域(城市id集)' AFTER `delivery_id`;

ALTER TABLE `yoshop_delivery_rule` MODIFY COLUMN `region_text` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '可配送区域(文字展示)' AFTER `region`;

ALTER TABLE `yoshop_express` ADD COLUMN `kdniao_code` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '物流公司编码 (快递鸟)' AFTER `kuaidi100_code`;

ALTER TABLE `yoshop_express` MODIFY COLUMN `express_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '物流公司名称' AFTER `express_id`;

ALTER TABLE `yoshop_express` MODIFY COLUMN `kuaidi100_code` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '物流公司编码 (快递100)' AFTER `express_name`;

CREATE INDEX `express_name` ON `yoshop_express`(`express_name`) USING BTREE ;

ALTER TABLE `yoshop_goods` ADD COLUMN `is_restrict` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否开启限购(0未开启 1已开启)' AFTER `deduct_stock_type`;

ALTER TABLE `yoshop_goods` ADD COLUMN `restrict_total` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '总限购数量(0为不限制)' AFTER `is_restrict`;

ALTER TABLE `yoshop_goods` ADD COLUMN `restrict_single` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '每单限购数量(0为不限制)' AFTER `restrict_total`;

ALTER TABLE `yoshop_goods` ADD COLUMN `is_ind_delivery_type` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否单独设置配送方式(0关闭 1开启)' AFTER `alone_grade_equity`;

ALTER TABLE `yoshop_goods` ADD COLUMN `delivery_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商品配送方式(仅单独设置时有效)' AFTER `is_ind_delivery_type`;

ALTER TABLE `yoshop_goods` MODIFY COLUMN `goods_type` tinyint(3) UNSIGNED NOT NULL DEFAULT 10 COMMENT '商品类型(10实物商品)' AFTER `goods_id`;

ALTER TABLE `yoshop_goods` MODIFY COLUMN `goods_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商品名称' AFTER `goods_type`;

ALTER TABLE `yoshop_goods` MODIFY COLUMN `goods_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商品编码' AFTER `goods_name`;

ALTER TABLE `yoshop_goods` MODIFY COLUMN `selling_point` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商品卖点' AFTER `video_cover_id`;

ALTER TABLE `yoshop_goods` MODIFY COLUMN `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '商品详情' AFTER `restrict_single`;

ALTER TABLE `yoshop_goods` MODIFY COLUMN `points_discount_config` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '单独设置积分抵扣的配置' AFTER `is_alone_points_discount`;

ALTER TABLE `yoshop_goods` MODIFY COLUMN `alone_grade_equity` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '单独设置折扣的配置' AFTER `is_alone_grade`;

ALTER TABLE `yoshop_goods_service` MODIFY COLUMN `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '服务名称' AFTER `service_id`;

ALTER TABLE `yoshop_goods_service` MODIFY COLUMN `summary` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '概述' AFTER `name`;

ALTER TABLE `yoshop_goods_sku` MODIFY COLUMN `goods_sku_id` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '商品sku唯一标识 (由规格id组成)' AFTER `id`;

ALTER TABLE `yoshop_goods_sku` MODIFY COLUMN `goods_sku_no` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商品sku编码' AFTER `image_id`;

ALTER TABLE `yoshop_goods_sku` MODIFY COLUMN `goods_props` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'SKU的规格属性(json格式)' AFTER `goods_weight`;

ALTER TABLE `yoshop_goods_sku` MODIFY COLUMN `spec_value_ids` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '规格值ID集(json格式)' AFTER `goods_props`;

ALTER TABLE `yoshop_h5_setting` MODIFY COLUMN `key` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '设置项标示' FIRST ;

ALTER TABLE `yoshop_h5_setting` MODIFY COLUMN `describe` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '设置项描述' AFTER `key`;

ALTER TABLE `yoshop_h5_setting` MODIFY COLUMN `values` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '设置内容(json格式)' AFTER `describe`;

ALTER TABLE `yoshop_help` MODIFY COLUMN `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '帮助标题' AFTER `help_id`;

ALTER TABLE `yoshop_help` MODIFY COLUMN `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '帮助内容' AFTER `title`;

ALTER TABLE `yoshop_order` ADD COLUMN `trade_id` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '第三方交易记录ID' AFTER `pay_time`;

ALTER TABLE `yoshop_order` ADD COLUMN `merchant_remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商家备注' AFTER `points_bonus`;

ALTER TABLE `yoshop_order` ADD COLUMN `order_source_data` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '来源记录的参数 (json格式)' AFTER `order_source_id`;

ALTER TABLE `yoshop_order` MODIFY COLUMN `order_no` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '订单号' AFTER `order_id`;

ALTER TABLE `yoshop_order` MODIFY COLUMN `order_type` tinyint(3) UNSIGNED NOT NULL DEFAULT 10 COMMENT '订单类型(10实物订单)' AFTER `order_no`;

ALTER TABLE `yoshop_order` MODIFY COLUMN `update_price` decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT '后台修改的订单金额(差价)' AFTER `pay_price`;

ALTER TABLE `yoshop_order` MODIFY COLUMN `buyer_remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '买家留言' AFTER `update_price`;

ALTER TABLE `yoshop_order` MODIFY COLUMN `delivery_type` tinyint(3) UNSIGNED NOT NULL DEFAULT 10 COMMENT '配送方式(10快递配送 20门店自提 30无需配送)' AFTER `trade_id`;

ALTER TABLE `yoshop_order` MODIFY COLUMN `delivery_status` tinyint(3) UNSIGNED NOT NULL DEFAULT 10 COMMENT '发货状态(10未发货 20已发货 30部分发货)' AFTER `express_price`;

ALTER TABLE `yoshop_order` MODIFY COLUMN `order_source` tinyint(3) UNSIGNED NOT NULL DEFAULT 10 COMMENT '订单来源(10普通订单 20砍价订单 30秒杀订单)' AFTER `is_comment`;

ALTER TABLE `yoshop_order` MODIFY COLUMN `platform` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '来源客户端 (APP、H5、小程序等)' AFTER `order_source_data`;

ALTER TABLE `yoshop_order` DROP COLUMN `pay_type`;

ALTER TABLE `yoshop_order` DROP COLUMN `express_id`;

ALTER TABLE `yoshop_order` DROP COLUMN `express_company`;

ALTER TABLE `yoshop_order` DROP COLUMN `express_no`;

ALTER TABLE `yoshop_order` DROP COLUMN `transaction_id`;

CREATE INDEX `pay_status` ON `yoshop_order`(`pay_status`) USING BTREE ;

CREATE INDEX `delivery_status` ON `yoshop_order`(`delivery_status`) USING BTREE ;

CREATE INDEX `receipt_status` ON `yoshop_order`(`receipt_status`) USING BTREE ;

CREATE INDEX `order_status` ON `yoshop_order`(`order_status`) USING BTREE ;

CREATE INDEX `is_settled` ON `yoshop_order`(`is_settled`) USING BTREE ;

CREATE INDEX `order_source` ON `yoshop_order`(`order_source`) USING BTREE ;

ALTER TABLE `yoshop_order_address` MODIFY COLUMN `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '收货人姓名' AFTER `order_address_id`;

ALTER TABLE `yoshop_order_address` MODIFY COLUMN `phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '联系电话' AFTER `name`;

ALTER TABLE `yoshop_order_address` MODIFY COLUMN `detail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '详细地址' AFTER `region_id`;

ALTER TABLE `yoshop_order_delivery` DROP COLUMN `pack_method`;

ALTER TABLE `yoshop_order_export` MODIFY COLUMN `file_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'excel文件路径' AFTER `end_time`;

ALTER TABLE `yoshop_order_goods` ADD COLUMN `goods_type` tinyint(3) UNSIGNED NOT NULL DEFAULT 10 COMMENT '商品类型(10实物商品)' AFTER `goods_id`;

ALTER TABLE `yoshop_order_goods` ADD COLUMN `delivery_status` tinyint(3) UNSIGNED NOT NULL DEFAULT 10 COMMENT '发货状态(10未发货 20已发货 30部分发货)' AFTER `total_pay_price`;

ALTER TABLE `yoshop_order_goods` ADD COLUMN `delivery_num` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '已发货数量' AFTER `delivery_status`;

ALTER TABLE `yoshop_order_goods` MODIFY COLUMN `order_goods_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '订单商品ID' FIRST ;

ALTER TABLE `yoshop_order_goods` MODIFY COLUMN `goods_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商品名称' AFTER `goods_type`;

ALTER TABLE `yoshop_order_goods` MODIFY COLUMN `goods_sku_id` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商品sku唯一标识' AFTER `spec_type`;

ALTER TABLE `yoshop_order_goods` MODIFY COLUMN `goods_props` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'SKU的规格属性(json格式)' AFTER `goods_sku_id`;

ALTER TABLE `yoshop_order_goods` MODIFY COLUMN `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '商品详情' AFTER `goods_props`;

ALTER TABLE `yoshop_order_goods` MODIFY COLUMN `goods_no` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商品编码' AFTER `content`;

ALTER TABLE `yoshop_order_refund` MODIFY COLUMN `apply_desc` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '用户申请原因(说明)' AFTER `type`;

ALTER TABLE `yoshop_order_refund` MODIFY COLUMN `refuse_desc` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商家拒绝原因(说明)' AFTER `audit_status`;

ALTER TABLE `yoshop_order_refund` MODIFY COLUMN `express_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '用户发货物流公司ID' AFTER `send_time`;

ALTER TABLE `yoshop_order_refund` MODIFY COLUMN `express_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '用户发货物流单号' AFTER `express_id`;

ALTER TABLE `yoshop_order_refund_address` MODIFY COLUMN `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '收货人姓名' AFTER `order_refund_id`;

ALTER TABLE `yoshop_order_refund_address` MODIFY COLUMN `phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '联系电话' AFTER `name`;

ALTER TABLE `yoshop_order_refund_address` MODIFY COLUMN `detail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '详细地址' AFTER `region_id`;

ALTER TABLE `yoshop_page` MODIFY COLUMN `page_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '页面名称' AFTER `page_type`;

ALTER TABLE `yoshop_page` MODIFY COLUMN `page_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '页面数据' AFTER `page_name`;

ALTER TABLE `yoshop_payment_template` MODIFY COLUMN `sort` int(11) UNSIGNED NOT NULL DEFAULT 100 COMMENT '排序(数字越小越靠前)' AFTER `wechatpay_serial`;

ALTER TABLE `yoshop_recharge_order` ADD COLUMN `pay_method` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '支付方式(微信/支付宝)' AFTER `actual_money`;

ALTER TABLE `yoshop_recharge_order` ADD COLUMN `trade_id` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '第三方交易记录ID' AFTER `pay_time`;

ALTER TABLE `yoshop_recharge_order` ADD COLUMN `platform` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '来源客户端(APP、H5、小程序等)' AFTER `trade_id`;

ALTER TABLE `yoshop_recharge_order` MODIFY COLUMN `order_no` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '订单号' AFTER `order_id`;

ALTER TABLE `yoshop_recharge_order` MODIFY COLUMN `store_id` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '商城ID' AFTER `platform`;

ALTER TABLE `yoshop_recharge_order` DROP COLUMN `transaction_id`;

ALTER TABLE `yoshop_recharge_order_plan` MODIFY COLUMN `plan_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '方案名称' AFTER `plan_id`;

ALTER TABLE `yoshop_recharge_order_plan` MODIFY COLUMN `store_id` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '商城ID' AFTER `gift_money`;

ALTER TABLE `yoshop_recharge_plan` MODIFY COLUMN `plan_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '套餐名称' AFTER `plan_id`;

ALTER TABLE `yoshop_recharge_plan` MODIFY COLUMN `store_id` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '商城ID' AFTER `is_delete`;

ALTER TABLE `yoshop_region` MODIFY COLUMN `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '区划名称' AFTER `id`;

ALTER TABLE `yoshop_region` MODIFY COLUMN `code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '区划编码' AFTER `pid`;

ALTER TABLE `yoshop_spec` MODIFY COLUMN `spec_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '规格组名称' AFTER `spec_id`;

ALTER TABLE `yoshop_spec_value` MODIFY COLUMN `spec_value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '规格值' AFTER `spec_value_id`;

ALTER TABLE `yoshop_store` MODIFY COLUMN `store_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商城名称' AFTER `store_id`;

ALTER TABLE `yoshop_store` MODIFY COLUMN `describe` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '商城简介' AFTER `store_name`;

ALTER TABLE `yoshop_store_address` MODIFY COLUMN `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '联系人姓名' AFTER `type`;

ALTER TABLE `yoshop_store_address` MODIFY COLUMN `phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '联系电话' AFTER `name`;

ALTER TABLE `yoshop_store_address` MODIFY COLUMN `detail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '详细地址' AFTER `region_id`;

ALTER TABLE `yoshop_store_role` MODIFY COLUMN `role_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '角色名称' AFTER `role_id`;

ALTER TABLE `yoshop_store_setting` MODIFY COLUMN `key` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '设置项标示' FIRST ;

ALTER TABLE `yoshop_store_setting` MODIFY COLUMN `describe` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '设置项描述' AFTER `key`;

ALTER TABLE `yoshop_store_setting` MODIFY COLUMN `values` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '设置内容(json格式)' AFTER `describe`;

ALTER TABLE `yoshop_store_user` MODIFY COLUMN `user_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '用户名' AFTER `store_user_id`;

ALTER TABLE `yoshop_store_user` MODIFY COLUMN `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '登录密码' AFTER `user_name`;

ALTER TABLE `yoshop_store_user` MODIFY COLUMN `real_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '姓名' AFTER `password`;

ALTER TABLE `yoshop_system_process` MODIFY COLUMN `key` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '进程标识' FIRST ;

ALTER TABLE `yoshop_system_process` MODIFY COLUMN `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL AFTER `key`;

ALTER TABLE `yoshop_upload_file` MODIFY COLUMN `storage` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '存储方式' AFTER `channel`;

ALTER TABLE `yoshop_upload_file` MODIFY COLUMN `domain` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '存储域名' AFTER `storage`;

ALTER TABLE `yoshop_upload_file` MODIFY COLUMN `file_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '文件名称(仅显示)' AFTER `file_type`;

ALTER TABLE `yoshop_upload_file` MODIFY COLUMN `file_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '文件路径' AFTER `file_name`;

ALTER TABLE `yoshop_upload_file` MODIFY COLUMN `file_ext` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '文件扩展名' AFTER `file_size`;

ALTER TABLE `yoshop_upload_file` MODIFY COLUMN `cover` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '文件封面' AFTER `file_ext`;

ALTER TABLE `yoshop_upload_group` MODIFY COLUMN `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '分组名称' AFTER `group_id`;

ALTER TABLE `yoshop_user` MODIFY COLUMN `mobile` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '用户手机号' AFTER `user_id`;

ALTER TABLE `yoshop_user` MODIFY COLUMN `nick_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '用户昵称' AFTER `mobile`;

ALTER TABLE `yoshop_user` MODIFY COLUMN `country` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '国家' AFTER `gender`;

ALTER TABLE `yoshop_user` MODIFY COLUMN `province` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '省份' AFTER `country`;

ALTER TABLE `yoshop_user` MODIFY COLUMN `city` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '城市' AFTER `province`;

ALTER TABLE `yoshop_user` MODIFY COLUMN `platform` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '注册来源客户端 (APP、H5、小程序等)' AFTER `grade_id`;

ALTER TABLE `yoshop_user_address` MODIFY COLUMN `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '收货人姓名' AFTER `address_id`;

ALTER TABLE `yoshop_user_address` MODIFY COLUMN `phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '联系电话' AFTER `name`;

ALTER TABLE `yoshop_user_address` MODIFY COLUMN `detail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '详细地址' AFTER `region_id`;

ALTER TABLE `yoshop_user_balance_log` MODIFY COLUMN `describe` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '描述/说明' AFTER `money`;

ALTER TABLE `yoshop_user_balance_log` MODIFY COLUMN `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '管理员备注' AFTER `describe`;

ALTER TABLE `yoshop_user_balance_log` MODIFY COLUMN `store_id` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '商城ID' AFTER `remark`;

ALTER TABLE `yoshop_user_coupon` MODIFY COLUMN `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '优惠券名称' AFTER `coupon_id`;

ALTER TABLE `yoshop_user_coupon` MODIFY COLUMN `apply_range_config` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '适用范围配置(json格式)' AFTER `apply_range`;

ALTER TABLE `yoshop_user_grade` MODIFY COLUMN `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '等级名称' AFTER `grade_id`;

ALTER TABLE `yoshop_user_grade` MODIFY COLUMN `upgrade` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '升级条件' AFTER `weight`;

ALTER TABLE `yoshop_user_grade` MODIFY COLUMN `equity` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '等级权益(折扣率0-100)' AFTER `upgrade`;

ALTER TABLE `yoshop_user_grade_log` MODIFY COLUMN `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '管理员备注' AFTER `change_type`;

ALTER TABLE `yoshop_user_oauth` MODIFY COLUMN `oauth_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '第三方登陆类型(MP-WEIXIN)' AFTER `user_id`;

ALTER TABLE `yoshop_user_oauth` MODIFY COLUMN `oauth_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '第三方用户唯一标识 (uid openid)' AFTER `oauth_type`;

ALTER TABLE `yoshop_user_oauth` MODIFY COLUMN `unionid` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '微信unionID' AFTER `oauth_id`;

ALTER TABLE `yoshop_user_points_log` MODIFY COLUMN `describe` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '描述/说明' AFTER `value`;

ALTER TABLE `yoshop_user_points_log` MODIFY COLUMN `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '管理员备注' AFTER `describe`;

ALTER TABLE `yoshop_user_points_log` MODIFY COLUMN `store_id` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '商城ID' AFTER `remark`;

ALTER TABLE `yoshop_wxapp_setting` MODIFY COLUMN `key` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '设置项标示' FIRST ;

ALTER TABLE `yoshop_wxapp_setting` MODIFY COLUMN `describe` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '设置项描述' AFTER `key`;

ALTER TABLE `yoshop_wxapp_setting` MODIFY COLUMN `values` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '设置内容(json格式)' AFTER `describe`;
