...
CREATE TABLE `yoshop_order` (
  ...
  `ios_refund_risk_status` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT 'iOS退款风险(0无 10服务冻结 20已退款)',
  `ios_refund_risk_source` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '首次风险来源',
  `ios_refund_risk_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '首次风险时间',
  ...
  KEY `ios_refund_risk_status` (`ios_refund_risk_status`),
...
CREATE TABLE `yoshop_payment_trade` (
  ...
  `platform` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '支付实现平台',
  `channel_class` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '支付渠道分类(0待确认 10非iOS 20iOS Apple)',
  ...
  `env` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '虚拟支付环境(0现网 1沙箱)',
  `product_id` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '虚拟支付道具ID',
  `goods_price` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '虚拟支付商品价格(分)',
  `attach` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '虚拟支付透传字段',
  `notify_times` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '通知次数',
  `last_notify_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '最近通知时间',
  `payload_snapshot` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '虚拟支付请求快照',
...
DROP TABLE IF EXISTS `yoshop_payment_ios_refund_inquiry`;
CREATE TABLE `yoshop_payment_ios_refund_inquiry` (
  ...
  `store_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '商城ID',
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
  `pay_order_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '上游支付订单号',
  `fingerprint` char(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '规范化请求SHA-256',
  `migration_key` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '历史迁移幂等键',
  `binding_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '交易订单绑定结果',
  `request_reason` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '用户退款原因',
  `request_payload` text COLLATE utf8mb4_unicode_ci COMMENT '认证问询原始请求',
  `service_stage` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'UNKNOWN' COMMENT '服务状态快照',
  ...
  `result_info` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '建议说明',
  `evidence` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '建议证据',
...
CREATE TABLE `yoshop_store` (
  ...
  `custom_domain` varchar(100) NOT NULL DEFAULT '' COMMENT '自定义H5域名',
  `sort` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '排序(数字越小越靠前)',
...
INSERT INTO `yoshop_store_api` VALUES ('11103', '充值订单', '/user.recharge/order', '11102', '100', '1614556800', '1614556800');
...
INSERT INTO `yoshop_store_menu` VALUES ('10070', '10', '充值订单', '/user/recharge/index', '1', '', '', '10069', '100', '1614556800', '1614556800');
...
INSERT INTO `yoshop_store_menu` VALUES ('10078', '10', '文章分类', '/content/article/category/index', '1', '', '', '10073', '120', '1614556800', '1614556800');
...
INSERT INTO `yoshop_store_menu` VALUES ('10311', '10', '创建文章', '/content/article/create', '1', '', '', '10073', '105', '1751637320', '1751637320');
INSERT INTO `yoshop_store_menu` VALUES ('10312', '10', '编辑文章', '/content/article/update', '1', '', '', '10073', '110', '1751637340', '1751637340');
...
DELETE FROM `yoshop_store_menu_api` WHERE (`menu_id`='10075');
DELETE FROM `yoshop_store_menu_api` WHERE (`menu_id`='10076');
INSERT INTO `yoshop_store_menu_api` VALUES ('11927', '10311', '11108', '1751637362');
INSERT INTO `yoshop_store_menu_api` VALUES ('11928', '10311', '11112', '1751637362');
INSERT INTO `yoshop_store_menu_api` VALUES ('11929', '10311', '11106', '1751637362');
INSERT INTO `yoshop_store_menu_api` VALUES ('11930', '10311', '11105', '1751637362');
INSERT INTO `yoshop_store_menu_api` VALUES ('11931', '10311', '11111', '1751637362');
INSERT INTO `yoshop_store_menu_api` VALUES ('11932', '10312', '11184', '1751637380');
INSERT INTO `yoshop_store_menu_api` VALUES ('11933', '10312', '11109', '1751637380');
INSERT INTO `yoshop_store_menu_api` VALUES ('11934', '10312', '11112', '1751637380');
INSERT INTO `yoshop_store_menu_api` VALUES ('11935', '10312', '11106', '1751637380');
INSERT INTO `yoshop_store_menu_api` VALUES ('11936', '10312', '11105', '1751637380');
INSERT INTO `yoshop_store_menu_api` VALUES ('11937', '10312', '11111', '1751637380');
