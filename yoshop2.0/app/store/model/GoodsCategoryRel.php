...
class GoodsCategoryRel extends GoodsCategoryRelModel
{
     ...
     * @return int
     */
    public static function getCountByCategoryId(int $categoryId): int
    {
     ...
     * @return array
     */
    public static function getCategoryIds(int $goodsId): array
    {
     ...
     * @return array|false
     */
    public static function updates(int $goodsId, array $categoryIds)
    {
        // 已分配的分类集
     ...
     * @return array
     */
    public static function getCategoryIdsByGoodsId(int $goodsId): array
    {
        return (new static)->where('goods_id', '=', $goodsId)->column('category_id');
    }
}
